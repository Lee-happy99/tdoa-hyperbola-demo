...
# ------------------- 绘图 -------------------
fig, ax = plt.subplots(figsize=(8, 7))  # 稍微缩小高度，减少滚动
ax.set_xlim(-20, 20)
ax.set_ylim(-20, 20)
ax.set_xlabel("x (km)")
ax.set_ylabel("y (km)")
...
ax.text(true_x, true_y+1.2, "目标点", color='red', fontsize=10, ha='center', weight='bold')
...
if est_pos is not None:
    ...
    ax.text(est_pos[0], est_pos[1]+1.2, "估计点", color='orange', fontsize=10, ha='center')
